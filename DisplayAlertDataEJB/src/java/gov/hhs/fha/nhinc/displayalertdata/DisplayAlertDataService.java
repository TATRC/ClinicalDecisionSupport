 ...
 * @author cmatser
 */
@WebService(serviceName = "DisplayDataComponent", portName = "DisplayDataComponentPortSoap11", endpointInterface = "gov.hhs.fha.nhinc.aggregator.DisplayDataComponentPortType", targetNamespace = "urn:gov:hhs:fha:nhinc:aggregator", wsdlLocation = "META-INF/wsdl/DisplayAlertDataService/DisplayDataComponent.wsdl")
@Stateless
public class DisplayAlertDataService implements DisplayDataComponentPortType {
