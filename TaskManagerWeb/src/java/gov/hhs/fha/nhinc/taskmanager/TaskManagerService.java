 ...
 * @author jharby
 */
@WebService(serviceName = "TaskManager", portName = "TaskManagerPortSoap11", endpointInterface = "gov.hhs.fha.nhinc.taskmanager.TaskManagerPortType", targetNamespace = "urn:gov:hhs:fha:nhinc:taskmanager", wsdlLocation = "WEB-INF/wsdl/TaskManagerService/TaskManager.wsdl")
